	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_area" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.new_area').click(function(){
			uni_modal("New Area","manage_area.php")
		})
		$('.manage_area').click(function(){
			uni_modal("Manage Area","manage_area.php?id="+$(this).attr('data-id'))
		})
