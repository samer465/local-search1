...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group text-dark">
              <label for="" class="control-label">Service Category</label>
          ...
          <div class="col-md-6">
            <div class="form-group text-dark">
              <label for="" class="control-label">Areas Serving</label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group text-dark">
              <label for="" class="control-label">Provider Type</label>
              <select name="type" id="type" class="custom-select custom-select-sm">
                <option value="1" <?php echo isset($type) && $type == 1 ? "selected": '' ?>>Single/Freelancer</option>
                <option value="2" <?php echo isset($type) && $type == 2 ? "selected": '' ?>>Group/Company</option>
              </select>
            </div>
          </div>
        </div>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-persons_companies">Save</button>
